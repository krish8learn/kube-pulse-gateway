...
const file_health_v1_health_proto_rawDesc = "" +
	"\n" +
	"\x16health/v1/health.proto\x12\x13kubepulse.health.v1\".\n" +
	"\x12HealthCheckRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\"e\n" +
	"\x13HealthCheckResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\aservice\x18\x02 \x01(\tR\aservice\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\tR\ttimestamp2k\n" +
	"\rHealthService\x12Z\n" +
	"\x05Check\x12'.kubepulse.health.v1.HealthCheckRequest\x1a(.kubepulse.health.v1.HealthCheckResponseB3Z1github.com/krish/kube-pulse-gateway/gen/health/v1b\x06proto3"
...
var file_health_v1_health_proto_goTypes = []any{
	(*HealthCheckRequest)(nil),  // 0: kubepulse.health.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil), // 1: kubepulse.health.v1.HealthCheckResponse
}
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: kubepulse.health.v1.HealthService.Check:input_type -> kubepulse.health.v1.HealthCheckRequest
	1, // 1: kubepulse.health.v1.HealthService.Check:output_type -> kubepulse.health.v1.HealthCheckResponse
